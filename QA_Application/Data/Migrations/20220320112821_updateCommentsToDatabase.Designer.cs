...
namespace QA_Application.Data.Migrations
{
    ...
    [Migration("20220320112821_updateCommentsToDatabase")]
    partial class updateCommentsToDatabase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QA_Application.Models.Comments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QA_Application.Models.SpecialTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QA_Application.Models.Comments", b =>
                {
                    ...
                    b.HasOne("QA_Application.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
