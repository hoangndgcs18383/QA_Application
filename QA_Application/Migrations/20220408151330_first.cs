        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstDeadline = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FinalDeadline = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileSubmit = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ideas_Department_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Department",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ideas_SpecialTags_SpecialTagId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ideas_SpecialTagId",
                table: "Ideas",
                column: "SpecialTagId");

            migrationBuilder.CreateIndex(
                name: "IX_Thumbs_IdeaId",
                table: "Thumbs",
                column: "IdeaId");
